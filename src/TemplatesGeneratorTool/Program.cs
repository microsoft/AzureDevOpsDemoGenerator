...
namespace TemplatesGeneratorTool
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            AzureDevOpsAPI.Configuration vstsAPIConfiguration = new AzureDevOpsAPI.Configuration() { UriString = "https://" + accountName + ".visualstudio.com:", PersonalAccessToken = PAT, Project = projectName };
