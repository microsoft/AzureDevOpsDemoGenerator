                        ...
                        if (response === "100" || response === "") {
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    var proceedOrg = "<a href='" + link + "' target='_blank'><button type = 'button' class='btn btn-primary btn-sm' id = 'proceedOrg' style = 'margin: 5px;'> Proceed to organization</button></a>";
                                    ...
                                    var fb = "<a href='http://www.facebook.com/sharer.php?u=https://azuredevopsdemogenerator.azurewebsites.net/&amp;t=Azure+Devops+Demo+Generator' target='_blank'><img src='/Images/facebook.png' style='width:20px;'></a>&nbsp;&nbsp;";
                                    var linkedin = "<a href='https://www.linkedin.com/shareArticle?mini=true&amp;url=https://azuredevopsdemogenerator.azurewebsites.net/&amp;t=Azure+Devops+Demo+Generator' target='_blank'><img src='/Images/linkedin.png' style='width:20px;'></a>&nbsp;&nbsp;";
                                    var twitter = "<a href='https://twitter.com/intent/tweet?url=https://azuredevopsdemogenerator.azurewebsites.net/&amp;text=Azure+DevOps+Demo+Generator&amp;via=visualstudio&amp;hashtags=azuredevopsdemogenerator,DevOpsLabs' target='_blank'><img src='/Images/twitter.png' style='width:20px;'></a>&nbsp;&nbsp;";
