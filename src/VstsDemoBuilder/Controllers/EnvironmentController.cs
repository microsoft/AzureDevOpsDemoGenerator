...
namespace VstsDemoBuilder.Controllers
{
    public class EnvironmentController : ApiController
    {
        ...
        [HttpPost]
        public HttpResponseMessage create(Project model)
        {
            try
            {
                ...
                {
                    HttpResponseMessage response = GetprojectList(model.accountName, model.accessToken);
            ...
            model.ProjectName = model.Name + "_" + DateTime.Now.ToString("yyyyMMddHHmmss") + "_" + model.TemplateName;
            ...
            return Request.CreateResponse(HttpStatusCode.Accepted, proJobject);
        }
        ...
        {
            model.SelectedTemplate = model.TemplateName;
