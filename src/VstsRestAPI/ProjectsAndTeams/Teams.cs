...
namespace VstsRestAPI.ProjectsAndTeams
{
    public class Teams : ApiServiceBase
    {
        ...
        public TeamMemberResponse.TeamMembers GetTeamMembers(string projectName, string teamaName)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t GetTeamMembers \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
        ...
        public string CreateArea(string projectName, string areaName)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t CreateArea \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
            return string.Empty;
        }
        ...
        public bool SetAreaForTeams(string projectName, string teamName, string json)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t SetAreaForTeams \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
            return false;
        }
        ...
        public bool SetBackLogIterationForTeam(string iterationId, string projectName, string teamName)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t SetBackLogIterationForTeam \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
            return false;
        }
        ...
        public TeamIterationsResponse.Iterations GetAllIterations(string projectName)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t GetAllIterations \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
        ...
        public bool SetIterationsForTeam(string IterationId, string teamName, string projectName)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t SetIterationsForTeam \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
            return false;
        }
        ...
        public TeamResponse GetTeamByName(string projectName, string teamaName)
        {
            ...
            {
                logger.Debug(DateTime.UtcNow.ToString("yyyy-MM-dd HH:mm:ss") + "\t GetTeamByName \t" + ex.Message + "\t" + ex.InnerException.Message + "\n" + ex.StackTrace + "\n");
            }
